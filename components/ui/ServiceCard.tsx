...
export function ServiceCard({ title, description, icon: Icon }: ServiceProps) {
  return (
    <m.div
      ...
      className="relative p-8 rounded-2xl bg-surface/80 backdrop-blur-md border border-primary-600/20 group overflow-hidden transition-transform transition-opacity transition-colors duration-300"
    >
